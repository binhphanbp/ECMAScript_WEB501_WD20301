...
hotDiv.innerHTML = htmlHot;

const phoneDiv = document.getElementById('phone');
let htmlPhone = '';
products
  .filter((products) => products.category === 'điện thoại')
  .forEach((product) => {
    htmlPhone += `
    <div class='product'>
      <img src='${product.image}'>
...
laptopDiv.innerHTML = htmlLaptop;
