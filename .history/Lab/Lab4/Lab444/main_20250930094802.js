...
function getActiveVoucher() {
  // Luôn ưu tiên voucher đang được chọn trên trang Cart
  return (
...
document.addEventListener('DOMContentLoaded', () => {
  // Chỉ thêm listener cho trang Cart
...
function loadSelectedAddress() {
  ...
  if (index === 'new-address') {
    ...
    fullNameEl.focus(); // Tập trung vào trường tên
    return;
  }
...
function renderCheckoutSummary() {
  // Giả định voucher đang áp dụng là SALE10 (hoặc logic phức tạp hơn nếu lưu LocalStorage)
...
function placeOrder() {
  ...
  // 2. Tính toán tổng kết (Dựa trên trạng thái hiện tại)
